# $Id: JavaRunner.pm 228 2008-11-19 17:12:40Z jsitz_jcvi $
#
# File: JavaRunner.pm
# Authors: Jeff Sitz
#
...
our $JAVARUNNER_VERSION = "0.90";
our $JAVARUNNER_BUILD = (qw/$Revision: 228 $/ )[1];
...
sub getCommandArgumentList($)
{
    ...
    push(@args, sprintf("-Xmx%dm", $self->{'initHeap'})) if (defined $self->{'maxHeap'});
